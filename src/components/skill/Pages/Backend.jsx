...
import BackendDoc from "../../../assets/courses/backend.pdf";
...
const Backend = ({ toggle }) => {
  const skillsGain = [
    ...
    { name: "Web frameworks and libraries" },
  ];
    ...
    <div className={`w-full h-full mb-[100px] flex flex-col font-poppins `}>
      ...
      <div className=' w-11/12 mx-auto flex flex-col gap-[50px] mt-6 ' >
        <div className='flex md:flex-row flex-col justify-between items-center gap-[50px]'>
          <div className='w-[100%] flex flex-col gap-12 rounded-lg bg-[#55cea4] p-10 relative'>
            <p className={`text-xl sm:text-5xl font-bold ${toggle === false ? "text-white" : "text-white"}`}>Master Backend Development :<br/>
            ...
            <div>
            <Link to="/enroll-backend-development-course" >
        ...
        <div className='w-[100%] flex gap-10'>
          ...
          <p className={`text-xl sm:text-2xl font-bold ${toggle === false ? "text-[#12372A]" : "text-white"}`}>Why students should learn Backend Development ?</p>
          <div className='grid lg:grid-cols-2 gap-[20px]'>
            ...
            <div className='flex gap-2 items-start'>
              <TiTick className='w-[100px]' />
              <p className={`text-justify text-sm leading-6 ${toggle === false ? "text-[#436860]" : "text-slate-200"}`}><strong>Build a strong foundation in programming :</strong> Learning backend development helps students build a strong foundation in programming concepts, including data structures, algorithms, and object-oriented programming</p>
            </div>
            <div className='flex gap-2 items-start'>
              <TiTick className='w-[100px]' />
              <p className={`text-justify text-sm leading-6 ${toggle === false ? "text-[#436860]" : "text-slate-200"}`}><strong>Create dynamic web applications :</strong> Students learn how to create dynamic web applications that can interact with databases, perform server-side logic, and provide a seamless user experience. This includes learning about web frameworks, APIs, and templating engines</p>
            </div>
            <div className='flex gap-2 items-start'>
              <TiTick className='w-[100px]' />
              <p className={`text-justify text-sm leading-6 ${toggle === false ? "text-[#436860]" : "text-slate-200"}`}><strong>Understand cloud computing and deployment :</strong> Students learn about cloud computing, deployment, and DevOps practices, including how to deploy applications on cloud platforms, such as AWS and Azure</p>
            </div>
            <div className='flex gap-2 items-start'>
              <TiTick className='w-[100px]' />
          ...
          <div className=' w-[30%] flex flex-col gap-2 bg-white p-6 rounded-md ' >
            ...
            <a href={BackendDoc} download="Backend Development Syllabus" target='_blank' className=" flex text-green-700 mt-3 items-center gap-2 border-2 border-green-700 justify-center px-4 py-2 rounded-lg text-md transition-all duration-200 hover:text-white hover:bg-green-700 "   >Download full Syllabus Now</a>
          </div>
        </div>
      ...
      <div className=' w-[95%] md:w-[100%]  flex flex-row gap-[50px] ' >
        ...
        <img src={SalaryImg} className=' w-[250px] ml-5 ' />
            <h2 className={`text-lg font-bold ${toggle === false ? "text-[#12372A]" : "text-[#12372A]"}`}>Salary of a Backend Developer</h2>
            <ul className={` flex flex-col gap-2 list-decimal ${toggle === false ? "text-[#12372A]" : "text-white"} `} >
              <li>
                <p className={` text-sm ${toggle === false ? "text-[#436860]" : "text-slate-800"} `} >Entry-level : <strong>₹7 lakhs per annum </strong> </p>
              </li>
              <li>
                <p className={`  text-sm ${toggle === false ? "text-[#436860]" : "text-slate-800"} `} >Mid-level : <strong>₹13.1 lakhs per annum</strong></p>
              </li>
              <li>
                <p className={`  text-sm ${toggle === false ? "text-[#436860]" : "text-slate-800"} `} >Senior-level : <strong>₹33 lakhs per annum</strong> </p>
              </li>
            </ul>
          </div>
      </div>
      ...
      <div className=' bg-white rounded-md flex flex-col gap-3 px-10 py-5 h-[550px]' >
          <img src={PrepareImg} className=' w-[300px] ' />
            <h2 className={`text-lg font-bold ${toggle === false ? "text-[#12372A]" : "text-[#12372A]"}`}>Prepare for a career as a Backend Developer</h2>
            <ul className={` flex flex-col gap-2 list-decimal ${toggle === false ? "text-[#12372A]" : "text-white"} `} >
              <li>
                <p className={` text-sm ${toggle === false ? "text-[#436860]" : "text-slate-800"} `} >Learn the basics</p>
              </li>
              <li>
                <p className={`  text-sm ${toggle === false ? "text-[#436860]" : "text-slate-800"} `} >Get familiar with backend frameworks</p>
              </li>
              <li>
                <p className={`  text-sm ${toggle === false ? "text-[#436860]" : "text-slate-800"} `} >Understand databases</p>
              </li>
              <li>
                <p className={` text-sm ${toggle === false ? "text-[#436860]" : "text-slate-800"} `} >Learn about API design and development</p>
              </li>
            </ul>
          </div>
          ...
          <img src={CareerImg} className=' w-[300px] h-[200px] object-cover ' />
            <h2 className={`text-lg font-bold ${toggle === false ? "text-[#12372A]" : "text-[#12372A]"}`}>Career opportunities for Backend Developers</h2>
            <ul className={` flex flex-col gap-2 list-decimal ${toggle === false ? "text-[#12372A]" : "text-white"} `} >
              <li>
                <p className={` text-sm ${toggle === false ? "text-[#436860]" : "text-slate-800"} `} >Senior Backend Developer
</p>
              </li>
              <li>
              ...
              <li>
                <p className={`  text-sm ${toggle === false ? "text-[#436860]" : "text-slate-800"} `} >DevOps Engineer</p>
              </li>
              <li>
                <p className={` text-sm ${toggle === false ? "text-[#436860]" : "text-slate-800"} `} >Backend Technical Architect</p>
              </li>
            </ul>
          </div>
          <div className=' bg-white rounded-md flex flex-col gap-3 px-10 py-5 h-[550px] ' >
          <img src={InterviewImg} className=' w-[300px] ' />
            <h2 className={`text-lg font-bold ${toggle === false ? "text-[#12372A]" : "text-[#12372A]"}`}>Interview opportunities for Backend Developers</h2>
            <ul className={` flex flex-col gap-2 list-decimal ${toggle === false ? "text-[#12372A]" : "text-white"} `} >
              <li>
