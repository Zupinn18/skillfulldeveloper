...
import FullstackDoc from "../../../assets/courses/fullstack.pdf";
import { Link } from 'react-router-dom';

const FullStack = ({ toggle }) => {
  const skillsGain = [
    { name: "Frontend" },
    { name: "Backend" },
  ...
  return (
    <div className={`w-full h-full mb-[100px] flex flex-col font-poppins `}>
      ...
      <div className=' w-11/12 mx-auto flex flex-col gap-[50px] mt-6 ' >
        ...
        <div className='w-[100%] flex gap-10'>
          ...
          <div className=' w-[30%] flex flex-col gap-2 bg-white p-6 rounded-md ' >
            ...
            <a href={FullstackDoc} download="Fullstack Development Syllabus" target='_blank' className=" flex text-green-700 mt-3 items-center gap-2 border-2 border-green-700 justify-center px-4 py-2 rounded-lg text-md transition-all duration-200 hover:text-white hover:bg-green-700 "   >Download Fullstack Syllabus</a>
          </div>
        </div>
      ...
      <div className=' w-[95%] md:w-[100%]  flex flex-row gap-[50px] ' >
        ...
        <h2 className={`text-lg font-bold ${toggle === false ? "text-[#12372A]" : "text-white"}`}>Salary of a Fullstack Developer</h2>
            <ul className={` flex flex-col gap-2 list-decimal ${toggle === false ? "text-[#12372A]" : "text-white"} `} >
            <li>
                <p className={` text-sm ${toggle === false ? "text-[#436860]" : "text-slate-200"} `} >Entry-level : <strong>₹1–₹8 lakhs per annum</strong> </p>
              </li>
              <li>
                <p className={`  text-sm ${toggle === false ? "text-[#436860]" : "text-slate-200"} `} >Mid-level : <strong>₹4- ₹10 lakhs per annum</strong></p>
              </li>
              <li>
                <p className={`  text-sm ${toggle === false ? "text-[#436860]" : "text-slate-200"} `} >Senior-level : <strong>₹9- ₹25 lakhs per annum</strong> </p>
              </li>
            </ul>
          </div>
      </div>
