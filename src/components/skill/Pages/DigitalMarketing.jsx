    ...
    >
        ...
        <div className=' w-11/12 mx-auto flex flex-col gap-[50px] mt-6 ' >
          ...
          <div className='flex md:flex-row flex-col justify-between items-center gap-[50px]  ' >
              <div className=' w-[100%] md:h-[380px] flex flex-col gap-5 rounded-lg bg-[#55cea4] p-10 ' >
                ...
                <div>
                  ...
                  className='cursor-pointer font-semibold px-8 py-3 flex flex-col items-center rounded-lg bg-[#436850] transition-all duration-300
                      border-2 text-white hover:bg-[#12372A] border-none mt-12
                      '
                  >Enroll Now
          ...
          <div className=' w-[100%] flex flex-col gap-10 rounded-lg relative ' >
                ...
                <div className=' w-[67%] flex flex-col gap-5 ' >
                  ...
                  <div className='flex flex-wrap flex-col md:flex-row gap-3 items-start ' >
                    {
          ...
          <div className=' w-[95%] md:w-[70%] flex flex-col gap-[50px] ' >
              ...
              <div className=' flex flex-col md:flex-row items-center justify-between gap-[25px] ' >
                ...
                <li>
                  <p className={`  text-sm ${toggle === false ? "text-[#436860]" : "text-slate-200"} `} >Develop digital skills such as SEO, social media marketing, etc.</p>
                </li>
                <li>
                  <p className={`  text-sm ${toggle === false ? "text-[#436860]" : "text-slate-200"} `} >Get familiar with tools and software</p>
                </li>
                <li>
                  <p className={` text-sm ${toggle === false ? "text-[#436860]" : "text-slate-200"} `} >Stay up-to-date with industry trends</p>
                </li>
              </ul>
                </div>
