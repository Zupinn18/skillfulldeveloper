...
import MernDoc from "../../../assets/courses/mernstack.pdf";
      ...
      <div className=' w-11/12 mx-auto flex flex-col gap-[50px] mt-6 ' >
        <div className='flex md:flex-row flex-col justify-between items-center gap-[50px]'>
          <div className='w-[100%] flex flex-col gap-12 rounded-lg bg-[#55cea4] p-10 relative'>
            ...
            <div>
            <Link to="/enroll-mern-stack-course" >
        ...
        <div className='w-[100%] flex flex-col md:flex-row gap-5 md:gap-10'>
          ...
          <div className=' w-[30%] flex flex-col gap-2 bg-white p-6 rounded-md ' >
            ...
            <a href={MernDoc} download="MERN Stack Syllabus" target='_blank' className=" flex text-green-700 mt-3 items-center gap-2 border-2 border-green-700 justify-center px-4 py-2 rounded-lg text-md transition-all duration-200 hover:text-white hover:bg-green-700 "   >Download full Syllabus Now</a>
          </div>
        </div>
      ...
      <div className=' w-[95%] md:w-[100%]  flex flex-row gap-[50px] ' >
        ...
        <h2 className={`text-lg font-bold ${toggle === false ? "text-[#12372A]" : "text-white"}`}>Salary of a MERN Developer</h2>
            ...
            <li>
              ...
              <li>
                <p className={`  text-sm ${toggle === false ? "text-[#436860]" : "text-slate-200"} `} >Mid-level : <strong>₹6-₹12 lakhs per annum</strong></p>
              </li>
              <li>
                <p className={`  text-sm ${toggle === false ? "text-[#436860]" : "text-slate-200"} `} >Senior-level : <strong>₹15-₹25 lakhs per annum</strong> </p>
              </li>
            </ul>
          </div>
      </div>
