        ...
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <div>
                ...
                <ul class="mt-6 space-y-4">
                    ...
                    <li>
                        <a href="#" title=""class={`flex text-base  transition-all duration-200 ${toggle === false ? "text-black hover:text-green-700 focus:text-green-700" : "text-[#adbc9f] hover:text-green-300 focus:text-green-300 " } `}> Works </a>
                    </li>

                    <li>
                        <a href="#" title=""class={`flex text-base  transition-all duration-200 ${toggle === false ? "text-black hover:text-green-700 focus:text-green-700" : "text-[#adbc9f] hover:text-green-300 focus:text-green-300 " } `}> Career </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                ...
                <form action="#" method="POST" class="mt-6">
                    <div>
                        ...
                        <input type="email" name="email" id="email" placeholder="Enter your email" class="block w-full p-4 text-[#adbc9f] placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-green-600 caret-green-600" />
                    </div>

                    <button type="submit" class="inline-flex items-center justify-center px-6 py-4 mt-3 font-semibold text-white transition-all duration-200 bg-[#12372A] rounded-md hover:bg-[#0e3024] focus:bg-[#0e3024]">Subscribe</button>
                </form>
            </div>
        </div>
