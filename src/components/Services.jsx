  ...
  return (
    <div className=' w-11/12 mx-auto flex flex-col gap-7 justify-center items-center mt-[70px] ' >
        ...
        <div className=' w-10/12 mx-auto flex flex-col md:flex-row items-center justify-center gap-10 ' >
            <div className=' md:w-[30%] flex flex-col gap-1 items-center ' >
                <img src={img1} className=' md:mt-[-50px] w-[260px] h-[200px] object-cover ' />
                {/* 12372A */}
        ...
        <div className='md:w-[30%] flex flex-col gap-1 items-center'>
            ...
            <div className='md:w-[30%] flex flex-col items-center gap-1'>
