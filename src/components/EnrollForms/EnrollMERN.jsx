...
const EnrollMERN = ({toggle}) => {
  ...
  <div class="py-8 lg:py-16 px-4 max-w-screen-md mx-auto">
      <h2 className={` ${toggle === true ? " text-white " :" text-[#12372A] " } mb-4 text-4xl tracking-tight font-bold text-center `}>Enroll Now For MERN Course</h2>
      {/* 436850 */}
